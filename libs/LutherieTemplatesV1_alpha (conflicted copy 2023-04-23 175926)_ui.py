...
################################################################################
## Form generated from reading UI file 'LutherieTemplatesV1_alpha (conflicted copy 2023-04-23 175926).ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.BuildFretteBoardButton.sizePolicy().hasHeightForWidth())
        self.BuildFretteBoardButton.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.SaveAsSVGButton.sizePolicy().hasHeightForWidth())
        self.SaveAsSVGButton.setSizePolicy(sizePolicy2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"LuTOOL - Guitar making Tools&Jigs", None))
